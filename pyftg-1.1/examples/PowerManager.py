    ...
    def askLevel(self, wait: float, time: str = "now") -> int:
        ...
        if(time=="now"):
            ...
            try:
                ...
                #print(set_time)
                now=set_time.replace(tzinfo=datetime.timezone.utc)
        ...
        try:
            ...
            for doc in docs:
                ...
                #print(now - mydict['date'] , datetime.timedelta(seconds=wait))
                if( datetime.timedelta(seconds=0) < now - mydict['date'] < datetime.timedelta(seconds=wait)):
                    # print(doc.to_dict()) 
